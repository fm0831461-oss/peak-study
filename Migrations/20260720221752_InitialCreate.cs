        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyStudyHours = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudySources", x => x.StudySourceId);
                    table.ForeignKey(
                        name: "FK_StudySources_Subjects_SubjectId",
                        column: x => x.SubjectId,
                        principalTable: "Subjects",
                        principalColumn: "SubjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Units_StudySources_StudySourceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IslandItemId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IslandId = table.Column<int>(type: "int", nullable: false),
                    ItemType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    GrowthLevel = table.Column<int>(type: "int", nullable: false),
                    IsCompleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IslandItems", x => x.IslandItemId);
                    table.ForeignKey(
                        name: "FK_IslandItems_Islands_IslandId",
                        column: x => x.IslandId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlannedStartTime = table.Column<TimeOnly>(type: "time", nullable: false),
                    ...
                    ExtensionMinutes = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudyTasks_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "LessonId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FocusSessions", x => x.FocusSessionId);
                    table.ForeignKey(
                        name: "FK_FocusSessions_StudyTasks_StudyTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizAnswers_Options_OptionId",
                        column: x => x.OptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FocusSessions_StudyTaskId",
                table: "FocusSessions",
                column: "StudyTaskId");

            migrationBuilder.CreateIndex(
                name: "IX_IslandItems_IslandId",
                table: "IslandItems",
                column: "IslandId");

            migrationBuilder.CreateIndex(
                name: "IX_Islands_UserId",
                table: "Islands",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudySources_SubjectId",
                table: "StudySources",
                column: "SubjectId");

            migrationBuilder.CreateIndex(
                name: "IX_StudyTasks_LessonId",
                table: "StudyTasks",
                column: "LessonId");
